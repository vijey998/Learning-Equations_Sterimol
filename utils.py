...
network_parameters = {'train_val_split': .8,  # how data in train_val_file is split, .9 means 90% train 10% validation
                      'layer_width': 5,  # number of identical nodes per hidden layer
                      'batch_size': 1,  # size of data batches used for training
                      'learning_rate': 5e-4,
                      'beta1': .4,
                      ...
                      'penalty_every': 100,  # feed in penalty data for training and evaluate after every n epochs
